...
export default function Dashboard() {
    ...
    if (loading) return <div className="flex items-center justify-center min-h-screen text-slate-500">Loading Dashboard...</div>;

    return (
        <div className="space-y-8">
            <div>
                <h1 className="text-2xl font-bold text-slate-900 dark:text-white">Dashboard Overview</h1>
                <p className="text-slate-500 dark:text-slate-400">Real-time summary of your service operations today.</p>
            </div>
                ...
                <Card className="h-fit">
                    ...
                    <div className="p-4 rounded-xl bg-indigo-50 dark:bg-indigo-900/10 text-indigo-700 dark:text-indigo-300 border border-indigo-100 dark:border-indigo-900/50">
                        <ul className="list-disc list-inside space-y-2 text-sm">
                            ...
                            <li>Manually assign staff from the queue once they become available.</li>
                            <li>Toggle staff availability in the Staff Management section.</li>
